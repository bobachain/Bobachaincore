/* src/config/bobachain-config.h.  Generated from bobachain-config.h.in by configure.  */
/* src/config/bobachain-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BOBACHAIN_CONFIG_H

#define BOBACHAIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/bobachain-dev/bobachain-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bobachain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bobachain Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bobachaincore"
