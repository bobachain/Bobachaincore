...
#define BOOST_TEST_MODULE Bobachain Test Suite

#include "test_bobachain.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bobachain_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
