...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BobachainNetwork") type = BobachainNetwork;
    if(strType == "BobachainNetworkVariable") type = BobachainNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BobachainNetwork) s = "BobachainNetwork";
    if(type == BobachainNetworkVariable) s = "BobachainNetworkVariable";
