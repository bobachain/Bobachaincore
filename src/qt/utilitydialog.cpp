    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bobachain Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bobachain Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bobachain-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bobachain in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BOBA, 0.1 BOBA, 1 BOBA and 10 BOBA -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bobachain Core is shutting down...") + "<br /><br />" +
