    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BOBA-light"), QVariant("light"));
    //ui->theme->addItem(QString("BOBA-light-hires"), QVariant("light-hires"));
    //ui->theme->addItem(QString("BOBA-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("BOBA-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("BOBA-traditional"), QVariant("trad"));
