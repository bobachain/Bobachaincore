    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bobachain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bobachain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bobachain: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bobachain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bobachain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bobachain Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bobachain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bobachain addresses"));
    ...
    openAction->setStatusTip(tr("Open a bobachain: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bobachain Core help message to get a list with possible Bobachain Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bobachain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bobachain network", "", count));
    } else {
...
{
    QString strTitle = tr("Bobachain Core"); // default title
    ...
    // Append title to "Bobachain Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
