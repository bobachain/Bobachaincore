...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bobachain Core bobachain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bobachain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bobachain transaction") + "\n" +
              "  bobachain-tx [options] -create [commands]   " + _("Create hex-encoded bobachain transaction") + "\n" +
              "\n";
