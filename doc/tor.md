TOR SUPPORT IN BOBACHAIN CORE
=======================

It is possible to run Bobachain Core as a Tor hidden service, and connect to such services.
...
1. Run Bobachain Core behind a Tor proxy
----------------------------------

The first step is running Bobachain Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./bobachaind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./bobachaind -proxy=127.0.0.1:9050


2. Run a Bobachain Core hidden server
-------------------------------
...
your bobachaind's P2P listen port (26118 by default).
	...
	-externalip=X   You can tell Bobachain Core about its publicly reachable address using
	                ...
	                /var/lib/tor/bobachaincore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./bobachaind -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./bobachaind ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./bobachaind -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known Bobachain Core Tor relays
------------------------------------
...
Bobachain Core has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
Bobachain Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if Bobachain Core is listening, and
