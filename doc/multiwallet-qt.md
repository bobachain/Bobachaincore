...
Only requiring some minor changes is bobachain.cpp.

Finally, two new headers and source files will have to be added to bobachain-qt.pro.
...
Changes to bobachain.cpp
----------------------
bobachain.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
