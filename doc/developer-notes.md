...
Bobachain Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 26118.
...
However, in open source software such as Bobachain Core, where everyone uses
...
pay attention to for reviewers of Bobachain Core code.

General Bobachain Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Bobachain Core uses tinyformat, which is type safe. Leave them out to avoid confusion
