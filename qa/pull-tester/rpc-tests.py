...
#Set env vars
buildDir = BUILDDIR
if "BOBACHAIND" not in os.environ:
    os.environ["BOBACHAIND"] = buildDir + '/src/bobachaind' + EXEEXT
if "BOBACHAINCLI" not in os.environ:
    os.environ["BOBACHAINCLI"] = buildDir + '/src/bobachain-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Bobachain Core
]
